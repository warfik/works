...
public class LineProcessorTest {
    ...
    public void testProcessLine_IlegalOperationLegalFormat_result() throws OperationNotSupportedException {
     ...
     //   assertEquals( LineProcessor.OPERATION_NOT_SUPPORTED_ERROR_MESSAGE line + LineProcessor.OPERATION_NOT_SUPPORTED_ERROR_MESSAGE + LineProcessor., lp.processLine(line));
    }
